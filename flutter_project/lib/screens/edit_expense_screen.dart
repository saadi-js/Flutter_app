...
/// Pre-fills form with current expense data
...
class _EditExpenseScreenState extends State<EditExpenseScreen> with SingleTickerProviderStateMixin {
  ...
  /// Validate and save updated expense
  void _saveExpense() {
    if (_formKey.currentState!.validate()) {
      // Create updated expense with lastEdited timestamp
      ...
      _buttonAnimationController.forward().then((_) {
        _buttonAnimationController.reverse().then((_) {
          // Return updated expense to previous screen
